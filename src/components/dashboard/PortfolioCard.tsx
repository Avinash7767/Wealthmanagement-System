...
const portfolioItems = [
  { name: 'Stocks', value: investments.stocks, allocation: (investments.stocks / totalInvestments) * 100, color: 'bg-chart-1' },
  { name: 'Mutual Funds', value: investments.mutualFunds, allocation: (investments.mutualFunds / totalInvestments) * 100, color: 'bg-chart-2' },
  { name: 'Fixed Deposits', value: investments.fixedDeposits, allocation: (investments.fixedDeposits / totalInvestments) * 100, color: 'bg-chart-3' },
  { name: 'PPF', value: investments.ppf, allocation: (investments.ppf / totalInvestments) * 100, color: 'bg-chart-4' },
];
